...
class SRData(data.Dataset):
    def __init__(self, cfg, name="", train=True, benchmark=False):
        ...
        if train:
            self.n_train_samples = (
                cfg.SOLVER.ITERATION_TOTAL * cfg.SOLVER.SAMPLES_PER_BATCH
            )
    ...
    def get_patch(self, lr, hr):
        ...
        while True:
            ...
            bicub_psnr = calc_psnr_numpy(
                bicub_sr, hr_patch, scale, float(self.cfg.DATASET.RGB_RANGE)
            )
